 ...
 */
int sistersEggs, duckbearEggs;

Console.Write("=========================== { The Four Sisters and the Duckbear } ============================\r" +
    "\nFour sisters own a chocolate farm and collect chocolate eggs laid by chocolate chickens every day. But\r" +
    "\nmore often than not, the number of eggs is not evenly divisible among the sisters, and everybody knows\r" +
    "\nyou cannot split a chocolate egg into pieces without ruining it. The arguments have grown more heated\r" +
    "\nover time. The town is tired of hearing the four sisters complain, and Chandra, the town’s Arbiter, has\r" +
    "\nfinally come up with a plan everybody can agree to. All four sisters get an equal number of chocolate\r" +
