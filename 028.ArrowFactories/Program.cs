...
// This file contains the essential components of the Arrow class, including the enums for arrowhead and fletching types,
// for now everything is in one file for simplicity, but in a real project, this class would likely be in its own file (e.g., Arrow.cs)
// and the enums should also be in separate files.
//-------------------------- Enums --------------------------
